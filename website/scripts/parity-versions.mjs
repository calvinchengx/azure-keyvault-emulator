...
// Must match `base` in astro.config.mjs and BASE in sync-docs.mjs. Every
// generated link below goes through it: the five that used to spell the
// prefix out inline were the ones that would have survived a base change
// and 404ed.
const BASE = '/azure-keyvault-emulator/docs/';
