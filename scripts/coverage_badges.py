...
TWO NUMBERS, because one would lie:
  ...
  go coverage   statement coverage of the Go unit and in-process server tests
...
catches consumer-facing defects here is the real-client fleet — the Python,
JavaScript and .NET SDK matrices, the az CLI, and azsecrets/azkeys/
azcertificates driving the vault directly.
