...
**[Security → Report a vulnerability](https://github.com/calvinchengx/azure-keyvault-emulator/security/advisories/new)**.
...
**azure-keyvault-emulator is a local development tool.** It stores secrets, keys,
