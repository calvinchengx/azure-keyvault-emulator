...
// timestamp — secret created/updated attributes, nbf/exp windows, soft-delete
// purge deadlines, token expiry checks — flows through Store.Now, which
// delegates here, so advancing or freezing this clock makes retention and
// expiry testable without real sleeps. Same clock as the rest of the family.
package clock
